...
const ContentContainer = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <main className="w-full h-full bg-darkMain flex flex-col items-center overflow-hidden">
      <div className="w-full h-full max-w-screen-3xl max-h-screen-3xl flex flex-col justify-center items-center relative p-1 md:p-16 lg:px-20 2xl:px-40">
        <motion.div
